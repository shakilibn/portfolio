...
const TravelValley = () => {
    return (
        <div className='main-container'>
            <h1 className='pl-4' style={{ color: '#05FDD8' }}>Some of my works</h1><hr />
            <div className="d-flex justify-content-center">
                <div>
                    <img className="d-inline my-3 mr-5 img-fluid" src={travelValley} alt="" style={{ height: '300px' }} />
                    <img className="img-fluid" src={travelValley2} alt="" style={{ height: '300px' }} />
                </div>
            </div>
            <div className="p-4">
                <h3>Travel Valley</h3>
